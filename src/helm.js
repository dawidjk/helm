 ...
 * Generated: 2026-07-07T00:12:43.379Z
 */

/**
 * helm theme — built by `npx astryx theme build`
...
export const helmTheme = {
  ...
  tokens: {
    ...
    "--color-accent": "light-dark(#2E6FF2, #4C8DFF)",
    "--color-accent-muted": "light-dark(#0057D533, #BDC2FF40)",
    "--color-neutral": "light-dark(#1B1B221A, #E2E2EB33)",
    ...
    "--color-text-primary": "light-dark(#1B1B22, #E2E2EB)",
    "--color-text-secondary": "light-dark(#454652, #AAAAB9)",
    "--color-text-disabled": "light-dark(#8F909E, #5D5D6A)",
    "--color-text-accent": "light-dark(#0041A9, #BDC2FF)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #002C82)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#0057D5, #BDC2FF)",
    "--color-icon-primary": "light-dark(#1B1B22, #E2E2EB)",
    ...
    "--color-border": "light-dark(#1B1B221A, #F0F0FA1A)",
    "--color-border-emphasized": "light-dark(#AAAAB9, #454652)",
