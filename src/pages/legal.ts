...
export const terms: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        `Unless your Order says otherwise, subscriptions run month to month with no minimum commitment. You may cancel at any time, effective at the end of the current billing period. We do not charge setup or cancellation fees.`,
