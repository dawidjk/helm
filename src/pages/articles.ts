...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        ps: [
          'Five: multi-factor authentication everywhere — the single control assessors check first. Six: FIPS-validated encryption for CUI at rest and in transit; your consumer-grade NAS probably does not qualify. Seven: access control — machinists do not need the quoting drive, and the front office does not need CAD.',
          'Eight: an incident response plan you have actually rehearsed once. Nine: System Security Plan (SSP) and POA&M documents — assessors read these before they read anything else. Thin, generic templates are the most common failure.',
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        ps: [
          ...
          'The controls that work are procedural, because procedure does not care how good the fake is. One: a payment-verification protocol — every new or changed payment instruction gets a callback to a known-good number, no exceptions, including "the CEO" personally. Two: a drill — simulate a voice-clone request against your own finance team before a criminal does. The first drill almost always finds someone who would have wired the money.',
        ],
      },
    ],
    takeaway:
