...
function DeadlineChip({ deadline }) {
  ...
  useEffect(() => {
    const target = (/* @__PURE__ */ new Date(`${deadline.iso}T00:00:00Z`)).getTime();
    const diffDays = Math.ceil((target - Date.now()) / (1e3 * 60 * 60 * 24));
...
function LanePage({ lane }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("header", { className: "hero lane", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "wrap", children: [
        lane.deadline && /* @__PURE__ */ jsx(DeadlineChip, { deadline: lane.deadline }),
...
function Pricing() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Band, { variant: "raised", children: /* @__PURE__ */ jsx("div", { className: "product-grid", children: productList.map((p, i) => /* @__PURE__ */ jsxs("div", { className: `product-tile observe d${i + 1}`, children: [
      ...
      /* @__PURE__ */ jsxs(Link, { to: `/${p.slug}`, className: "price", style: { textDecoration: "none", color: "light-dark(#0c7a44, #AAE2C4)" }, children: [
        "Learn more about ",
        p.name,
        " →"
      ] })
    ...
    /* @__PURE__ */ jsxs("header", { className: "hero lane", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "wrap", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hero-note reveal d3", children: [
          p.price,
          " · ",
          /* @__PURE__ */ jsx(Link, { to: "/pricing", style: { color: "light-dark(#0c7a44, #AAE2C4)" }, children: "full pricing" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Band, { variant: "raised", children: /* @__PURE__ */ jsxs("div", { className: "split", children: [
