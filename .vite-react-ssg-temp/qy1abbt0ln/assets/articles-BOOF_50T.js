const articles = [
  {
    ...
    metaDesc: "Authenticator apps, SMS codes, and hardware security keys all stop different attacks. A plain-English comparison for small and medium-sized businesses deciding where to start.",
    date: "2026-07-17",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
    laneTo: "/",
    intro: "Turning on MFA can stop a stolen password from becoming a stolen mailbox, bank login, or admin account. The method matters, though. Text messages, authenticator apps, and security keys fail in different ways, so the strongest option should protect the people who can move money or change systems.",
    sections: [
      {
    ...
    takeaway: "Turn on MFA everywhere first. Then give security keys to administrators and anyone who can move money, use authenticator apps with number matching for the rest of the team, and keep text messages as a fallback."
  },
  {
    slug: "m365-security-baseline",
    title: "The Microsoft 365 Security Baseline You Can Set This Week",
    metaDesc: "A practical Microsoft 365 security checklist for small and medium-sized businesses: MFA everywhere, no legacy authentication, separate admin accounts, and the forwarding rules attackers rely on after a breach.",
    date: "2026-07-16",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
  ...
  },
  {
    ...
    metaDesc: "Why password reuse is the most common small-team security failure, what a shared password vault adds beyond browser-saved logins, and the order to roll one out across your team.",
    date: "2026-07-14",
    updated: "2026-08-18",
    readMin: 4,
    lane: "All industries",
    laneTo: "/",
    intro: "Shared passwords often end up in a spreadsheet, a browser, or a message thread because the team needs a quick way to get into an account. The trouble appears when someone leaves or one reused password is exposed in an unrelated breach. The company then has to find every account that person knew before the access can be closed.",
    sections: [
      {
    ...
    takeaway: "A team vault makes it possible to use a different password for every service and remove someone from shared accounts in one place. Start with administrator, financial, and shared logins before moving the rest of the team."
  },
  {
  ...
  },
  {
    ...
    metaDesc: "The red flags that separate a legitimate vendor payment change from an invoice fraud attempt, and the callback habit that catches it every time.",
    date: "2026-07-12",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
    laneTo: "/",
    intro: "Invoice fraud succeeds when a familiar vendor appears to change its banking details and the payment goes out before anyone calls to confirm. The invoice may use the right amount, project, logo, and contact name. One altered account number is enough to send the money to a criminal.",
    sections: [
      {
    ...
    takeaway: "Treat every change to vendor banking details as unverified until someone calls a known number from the company’s existing records. Add a second approver for larger payments and protect your own domain from being used in the same scam."
  },
  {
    slug: "what-a-soc-actually-does",
    title: "What a SOC Actually Does (and Why an Alert Is Not the Same as a Response)",
    metaDesc: "What a security operations center actually does around the clock, why EDR software alone still needs a human behind it, and the questions to ask before buying a managed SOC subscription.",
    date: "2026-07-11",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
    laneTo: "/",
    intro: "Security software can raise an alert at 2 a.m., but the alert does not investigate itself. If nobody reviews it until the office opens, an attacker may have hours to spread, steal data, or disable systems. A security operations center provides the people who investigate those alerts and take action around the clock.",
    sections: [
      {
  ...
  },
  {
    ...
    takeaway: "Check that every application answer remains true throughout the policy year and keep dated evidence to support it. If a control stops working, fix it and document what happened before a future claim forces the issue."
  },
  {
    slug: "vendor-email-compromise-contractors",
    title: "Vendor Email Compromise: When Your Supplier's Invoice Is Actually a Scam",
    metaDesc: "How fraudsters compromise or spoof a supplier or general contractor to redirect payment on a real invoice, and the callback and DMARC controls that stop it before the money moves.",
    date: "2026-07-08",
    updated: "2026-08-18",
    readMin: 5,
  ...
  },
  {
    ...
    lane: "All industries",
    laneTo: "/",
    intro: "An employee who wants help summarizing a contract or cleaning up a client email may paste it into a public chatbot without realizing the information has now left the company’s approved systems. The employee is usually trying to work faster, not break a rule. If the company has never explained what is safe to share, people will make that decision on their own.",
    sections: [
      {
  ...
  },
  {
    ...
    takeaway: "Start several weeks before renewal. Verify each answer, save the supporting evidence, and either fix an incomplete control or describe it accurately before signing the form."
  },
  {
    slug: "hipaa-email-rules-small-practices",
    ctaMode: "book",
    title: 'HIPAA Email Rules for Small Practices: What "Addressable" Actually Means',
    metaDesc: "What the HIPAA Security Rule actually requires for email containing PHI, why an addressable specification is not the same as optional, and the baseline that keeps a small practice covered.",
    date: "2026-07-05",
    updated: "2026-08-18",
    readMin: 5,
    lane: "Professional Services",
    laneTo: "/professional-services",
    intro: "Emailing patient information to the wrong person, through a personal account, or without the safeguards the practice selected can create a breach investigation and a difficult patient conversation. HIPAA does not ban email, but the practice needs a documented way to protect electronic patient information while it is being sent.",
    sections: [
      {
    ...
    takeaway: "Use business email covered by a signed BAA, require MFA, train staff on when secure delivery is needed, and keep patient information out of personal accounts. If the practice chooses an alternative to an addressable safeguard, document why it is reasonable."
  },
  {
    slug: "ai-phishing-red-flags",
    title: 'AI Phishing: Why "Look for the Typos" Is Dead Advice',
    metaDesc: "AI-written phishing emails are fluent, personalized, and sent at scale. Why the old typo-spotting advice no longer works, and the controls that still stop the attack.",
    date: "2026-07-03",
    updated: "2026-08-18",
    readMin: 4,
    lane: "All industries",
    laneTo: "/",
    intro: "A polished phishing email can now match a colleague’s tone, mention a real vendor, and arrive without the spelling mistakes employees were taught to notice. If training still depends on spotting bad grammar, a convincing message can reach the payment or login step before anyone sees a warning sign.",
    sections: [
      {
        h: "What changed",
        ps: [
    ...
    takeaway: "Stop asking employees to judge an email by its grammar. Make suspicious messages easy to report, protect the domain and mailbox, and verify payment changes through a known phone number."
  },
  {
  ...
  },
  {
    ...
    takeaway: "On the employee’s last day, suspend the main account, revoke active sessions, remove MFA devices, rotate shared passwords, collect equipment, and close separately created apps. Give one person responsibility for confirming the list is complete."
  },
  {
    slug: "backup-testing-insurers",
    ctaMode: "book",
    title: "Backup Testing: What Cyber Insurers Actually Want to See",
    metaDesc: "Cyber insurance questionnaires now ask about offline and immutable backups, encryption, and tested restores, not just whether you back up. The 3-2-1 rule and how to document restore tests.",
    date: "2026-06-27",
    updated: "2026-08-18",
    readMin: 5,
    lane: "Professional Services",
    laneTo: "/professional-services",
    intro: "A backup can report “successful” every night and still fail when ransomware shuts down the business. It may be reachable from the infected network, missing important data, or impossible to restore within a useful amount of time. Cyber insurers ask about offline copies and restore tests because the existence of a backup does not prove the company can recover.",
    sections: [
      {
    ...
    takeaway: "Keep an offline or immutable copy and test a real restore on a schedule. Record what was restored, how long it took, who checked it, and what had to be fixed afterward."
  },
  {
    ...
    lane: "Professional Services",
    laneTo: "/professional-services",
    intro: "The cyber-insurance questionnaire can determine both the price of the policy and whether the coverage holds up after an incident. An optimistic answer about MFA, backups, or training may seem harmless during renewal, but it can be compared with technical records when the business files a claim.",
    sections: [
      {
    ...
    takeaway: "Verify every answer before signing, fix or accurately disclose incomplete controls, and save the evidence in one place. Helm Ready can help assess and organize the gaps under a fixed scope."
  },
  {
  ...
  },
  {
    ...
    metaDesc: "A vulnerability scan and a penetration test are not the same service. What each one actually delivers, how to spot a rebranded scan sold at pen test prices, and which one most small and medium-sized businesses need first.",
    date: "2026-06-13",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
    ...
    takeaway: "Ask who will perform the work, whether exploitation is included, which systems are in scope, and what the final report will show. Fix known basic weaknesses first so a later penetration test can spend its time on the paths an automated scan cannot answer."
  },
  {
    slug: "what-is-dmarc",
    ...
    lane: "All industries",
    laneTo: "/",
    intro: "If someone can send a convincing invoice from your company’s domain, a customer may pay the criminal and call you only after the real invoice becomes overdue. SPF, DKIM, and DMARC help receiving mail systems separate authorized messages from unauthorized ones sent in your name.",
    sections: [
      {
    ...
    takeaway: "Check which services send email for your domain, make sure each one is authenticated, and move DMARC toward enforcement only after legitimate senders are accounted for. The free scan shows what your public records currently publish."
  },
  {
    ...
    metaDesc: "What to do, who to call, and what not to touch in the first hour after ransomware or a business email compromise, plus why a one-page incident response plan beats a binder nobody reads.",
    date: "2026-06-06",
    updated: "2026-08-18",
    readMin: 5,
    lane: "All industries",
    ...
    takeaway: "Put the carrier’s number, decision owner, reporting deadline, and first instructions on one page. Train employees to preserve the evidence and use the approved response path before anyone starts cleaning up."
  },
  {
    ...
    lane: "All industries",
    laneTo: "/",
    intro: "A familiar voice is no longer proof that a payment request came from the owner. Criminals can clone public audio and use it to pressure an employee into sending money before there is time to ask questions. The loss happens because the company treats recognition as authorization.",
    sections: [
      {
    ...
    takeaway: "Require a callback to a known number and a second approval for high-consequence payment changes, even when the request sounds like the owner. Helm Aware can help write and rehearse that process."
  },
  {
